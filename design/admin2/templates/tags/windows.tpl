...
{if and( $tag_exists, $tag.main_tag_id|eq( 0 ) )}
    ...
    <div id="node-tab-tags-description-content" class="tab-content{if $tab_index|ne('description')} hide{else} selected{/if}">
        {include uri='design:tags/tabs/tag_description.tpl'}
        <div class="break"></div>
    </div>
{/if}
